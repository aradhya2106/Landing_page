  ...
  return (
    <div className="relative flex flex-col items-center justify-center text-white px-8 py-24 min-h-screen bg-black overflow-hidden" id="HeroBanner">
      ...
      <div className="relative z-20 flex flex-col items-center gap-10 max-w-5xl w-full text-center animate-fadeInUp">
        ...
        <div className="flex flex-wrap items-center justify-center gap-4 sm:gap-6 md:gap-8 mb-10 w-full px-2">
          <span className="font-sora font-light text-lg xs:text-xl sm:text-2xl md:text-3xl lg:text-4xl tracking-widest uppercase whitespace-nowrap">STRATEGY</span>
          ...
          <span className="font-sora font-light text-lg xs:text-xl sm:text-2xl md:text-3xl lg:text-4xl tracking-widest uppercase whitespace-nowrap">EXECUTION</span>
          <span className="w-2 h-2 sm:w-3 sm:h-3 rounded-full bg-gradient-to-tr from-[#30A0FF] to-[#B145FF] blur-[3px] sm:blur-[4px] shadow-lg mx-1 sm:mx-2" />
          <span className="font-sora font-light text-lg xs:text-xl sm:text-2xl md:text-3xl lg:text-4xl tracking-widest uppercase whitespace-nowrap">RESULTS</span>
        </div>
        {/* Main Heading */}
        <h1 className="font-sora font-bold text-4xl md:text-6xl lg:text-7xl mb-6">
          Web3. AI. <span className="bg-gradient-to-tr from-[#30A0FF] to-[#B145FF] bg-clip-text text-transparent">Growth. Delivered.</span>
        </h1>
        {/* Sub Heading */}
        <p className="font-sora text-lg md:text-xl text-white/90 mb-12 max-w-2xl mx-auto">
        ...
        <div className="flex justify-center items-center gap-6 flex-wrap mt-8">
          <Button
            className="rounded-full h-[56px] px-10 bg-gradient-to-r from-[#8f5cff] to-[#30A0FF] text-white font-bold min-w-[180px] shadow-lg active:scale-95 transition-transform font-sora text-lg hover:shadow-[0_0_16px_0_rgba(144,97,255,0.5)] focus:shadow-[0_0_16px_0_rgba(144,97,255,0.7)]"
