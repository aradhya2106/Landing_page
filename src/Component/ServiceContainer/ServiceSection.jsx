...
//         <h2 className="text-5xl font-bold text-gray-200 tracking-wide mb-4">
//           SERVICES
//         </h2>
//         <p className="text-xl">
//           Your All-In-One{" "}
...
//             <div
//               key={index}
//               className="relative bg-black border-[17px] border-[#2b2b2b] rounded-[7px] p-8 md:p-10 shadow-[0_0_30px_#0ff3ff22] hover:shadow-blue-500/40 transition duration-300"
//             >
//               {/* Lamp image INSIDE the border, top-left */}
...
//               {/* Card Content */}
//               <div className="grid grid-cols-[1fr_80px_1fr] items-center gap-6 z-10 relative mt-6">
//                 {/* Left Column */}
//                 <div>
//                   <h3
