    ...
    <div className="relative flex flex-col items-center justify-center text-white px-8 py-24 min-h-screen bg-black overflow-hidden" id="HeroBanner">
      ...
      <div className="relative z-20 flex flex-col items-center gap-10 max-w-5xl w-full text-center animate-fadeInUp">
        ...
        <div className="flex flex-wrap items-center justify-center gap-4 sm:gap-6 md:gap-5 mb-8 w-full px-2">
          <span className="font-sora font-light text-base xs:text-lg sm:text-xl md:text-1xl lg:text-2xl tracking-widest uppercase whitespace-nowrap">STRATEGY</span>
          ...
          <span className="font-sora font-light text-base xs:text-lg sm:text-xl md:text-1xl lg:text-2xl tracking-widest uppercase whitespace-nowrap">EXECUTION</span>
          <span className="w-2 h-2 sm:w-3 sm:h-3 rounded-full bg-gradient-to-tr from-[#30A0FF] to-[#B145FF] blur-[3px] sm:blur-[4px] shadow-lg mx-1 sm:mx-2" />
           <span className="font-sora font-light text-base xs:text-lg sm:text-xl md:text-1xl lg:text-2xl tracking-widest uppercase whitespace-nowrap">RESULTS</span>
        </div>
        {/* Main Heading */}
        <h1 className="font-sora font-light text-3xl md:text-5xl lg:text-6xl mb-0">
