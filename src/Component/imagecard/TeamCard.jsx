...
export default function TeamCard({ name, role, twitter, linkedin, image }) {
  return (
    <div className="relative w-40 sm:w-52 rounded-xl overflow-hidden shadow-md group bg-white">
      ...
      <div className="absolute bottom-0 w-full p-3 text-center z-10 transform translate-y-10 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500 ease-in-out">
